...
namespace FileSystem
{
  ...
  public:
    ...
    inline static std::string version() { return "ver 1.3"; }
	...
	// record all file Path found and get them

	void recordAddresses(const std::string& filename, const std::string& dirname);
  ...
  */
  ...
  //----< record and store addresses >---------------------

  inline void DirExplorerN::recordAddresses(const std::string& filename, const std::string& dirname)
  {
	  filePath.push_back(dirname);
	  fileNames.push_back(filename);
  }

  //----< get recorded file paths >---------------------

  inline std::vector<std::string> DirExplorerN::getPath()
  {
	  return filePath;
  }

  //----< get recorded file names >---------------------

  inline std::vector<std::string> DirExplorerN::getNames()
  {
	  return fileNames;
  }
